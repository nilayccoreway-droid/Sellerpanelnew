            ...
            <div className="px-6 py-3 border-b border-gray-200">
              <div className="flex space-x-6">
                <button
                  ...
                  className={`text-sm font-medium ${participationSubTab === 'all' ? 'text-blue-600' : 'text-gray-500'
                    }`}
                >
                  All(1)
                </button>
                <button
                  ...
                  className={`text-sm font-medium ${participationSubTab === 'coming-soon' ? 'text-blue-600' : 'text-gray-500'
                    }`}
                >
                  Coming Soon (0)
                </button>
                <button
                  ...
                  className={`text-sm font-medium ${participationSubTab === 'during' ? 'text-blue-600' : 'text-gray-500'
                    }`}
                >
                  During Promotion (1)
                </button>
                <button
                  ...
                  className={`text-sm font-medium ${participationSubTab === 'finish' ? 'text-blue-600' : 'text-gray-500'
                    }`}
                >
                  Finish(0)
                </button>
