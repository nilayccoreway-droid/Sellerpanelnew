...
export default function PhotoshootPage() {
  ...
  const statusItems = [
    ...
    { label: 'Shipped', count: shippedCount, percentage: (shippedCount / maxCount) * 100, color: 'bg-blue-500' },
  ];
      ...
      <div className="px-6 py-4">
        <div className="bg-white border border-gray-200 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded hover:bg-teal-700 transition-colors">
